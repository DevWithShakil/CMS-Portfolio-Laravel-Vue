<template>
    <div class="relative">
        ...
        <section id="skills" class="py-20 bg-slate-50 dark:bg-slate-900/50">
            ...
            <div class="max-w-7xl mx-auto px-6">
                ...
                >
                    <div
                        ...
                        :key="project.id"
                        class="group bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-lg hover:shadow-2xl transition-all duration-300"
                        data-aos="fade-up"
                    >
...
// Helper: Auto Icon Logic (Same as Admin)
...
const loadData = async () => {
    try {
        ...
        // 2. Skills (Get All)
        const skillRes = await api.get("/api/skills?all=true"); // ✅ Updated API Call
        skills.value = skillRes.data;

        // 3. Projects (Get Latest 3)
        const projRes = await api.get("/api/projects?limit=3"); // ✅ Updated API Call
